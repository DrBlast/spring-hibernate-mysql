...
public class MainController {
    ...
    public String getPersons(Model model) {
        ...
        logger.debug("Received request to show all personEntities");

        // Retrieve all personEntities by delegating the call to PersonService
        // Получает всех персон вызовом PersonService
        List<Person> personEntities = personService.getAll();

        // Attach personEntities to the Model
        // Прикрепляет персон к модели
        model.addAttribute("persons", personEntities);
